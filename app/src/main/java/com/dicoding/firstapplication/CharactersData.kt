...
object CharactersData {
    ...
    private val charNames = arrayOf("Lelouch Lamperouge",
        "Levi",
        "L Lawliet",
        "Monkey D. Luffy",
        "Rintarou Okabe",
    ...
    private val lelouch: String = "Anime: Code Geass\n" +
            ...
            "Knightmare: Sutherland, Burai, Gawain, Shinkirō\n" +
            "\n" +
            "Lelouch vi Britannia (ルルーシュ・ヴィ・ブリタニア, Rurūshu Vui Buritania) is the main protagonist of the anime/manga series Code Geass. He is the Eleventh Prince of the Holy Britannian Empire and the 98th Emperor of Britannia, Charles zi Britannia.\n" +
            "\n" +
    ...
    private val charDetail = arrayOf(lelouch, levi, l, luffy, okabe, light, zoro, killua, elric, naruto)



    private val charImage = intArrayOf(R.drawable.lelouch,
        R.drawable.levi,
        R.drawable.lawliet_l,
        R.drawable.luffy,
        R.drawable.rintarou_okabe,
        R.drawable.light_yagami,
        R.drawable.zoro,
        R.drawable.killua,
